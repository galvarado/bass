...
from .views import profile_detail, profile_edit,UserListView, ChangePasswordView, ChangePasswordDoneView, UserListView, UserCreateView, UserUpdateView, UserDeleteView, UserPasswordSetView
